...
<body>
    ...
    <div class="bg-[#14335B] text-white flex flex-col min-h-screen">
        ...
        <header class="flex justify-between items-center w-full max-w-6xl mx-auto">
            ...
            <div class="space-x-4">
                <a href="/login" class="bg-[#F7941E] hover:bg-[#d97d11] transition-all duration-200 text-white font-semibold px-8 py-2.5 rounded-xl">Entrar</a>
                <a href="/register" class="bg-[#F7941E] hover:bg-[#d97d11] transition-all duration-200 text-white font-semibold px-8 py-2.5 rounded-xl">Cadastrar</a>
            </div>
        </header>
